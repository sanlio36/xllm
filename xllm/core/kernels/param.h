...
// Mirrors vllm-ascend's Python path: transpose/NZ-convert int4 weights and
// fold first-level + second-level scales into the int64 dtype/layout consumed
// by npu_grouped_matmul. Torch fused MoE additionally packs weights to int32;
// the ATB grouped-matmul wrapper expects the original int8-packed tensor.
